...
const translations = {
    en: {
        ...
        feat1_title: 'Fast Delivery', feat1_desc: 'Data bundles delivered to your phone within 1-5 minutes, guaranteed.',
        ...
        faq1_q: 'How fast is bundle delivery?', faq1_a: 'Most requests are delivered in 1–5 minutes. During network peak times, it may take a bit longer.',
    ...
    fr: {
        ...
        hero_title: 'Forfaits Data Abordables<br>Tous Réseaux • Sans Expiry',
        ...
        feat1_title: 'Livraison Rapide', feat1_desc: 'Vos forfaits data livrés en 1-5 minutes, garanti.',
        ...
        faq1_q: 'Combien de temps prend la livraison?', faq1_a: 'La plupart des commandes sont livrées en 1-5 minutes.',
    ...
    tw: {
        ...
        hero_description: 'Nya data mua ntɛm ntɛm ma MTN, AirtelTigo ne Telecel dɛn biara. Gye ho sika kosi 40%.',
        ...
        faq1_q: 'Data bɛba ntɛm bɛn?', faq1_a: 'Ebia 1-5 aɛ. Bere a network yɛ deen no, ɛtumi twa kakra.',
    ...
    es: {
        ...
        hero_title: 'Paquetes de Datos Asequibles<br>Todas las Redes • Sin Vencimiento',
        ...
        feat1_title: 'Entrega Rápida', feat1_desc: 'Tus paquetes llegan a tu teléfono en 1-5 minutos, garantizado.',
        ...
        faq1_q: '¿Cuánto tarda la entrega?', faq1_a: 'La mayoría llega en 1-5 minutos.',
    ...
    pt: {
        ...
        hero_title: 'Pacotes de Dados Acessíveis<br>Todas as Redes • Sem Vencimento',
        ...
        feat1_title: 'Entrega Rápida', feat1_desc: 'Seus pacotes chegam em 1-5 minutos, garantido.',
        ...
        faq1_q: 'Quanto tempo leva a entrega?', faq1_a: 'A maioria chega em 1-5 minutos.',
    ...
    ar: {
        ...
        hero_title: 'حزم بيانات بأسعار معقولة<br>جميع الشبكات • لا تنتهي صلاحيتها',
        ...
        feat1_title: 'توصيل سريع', feat1_desc: 'احصل على حزم بياناتك خلال 1-5 دقائق، مضمون.',
        ...
        faq1_q: 'كم يستغرق التسليم؟', faq1_a: 'معظم الطلبات تُسلَّم في 1-5 دقائق.',
...
function displayStaticBundles() {
    displayBundles([
        { _id:'1', name:'1GB Weekly', size:'1GB', price:3.50, originalPrice:6.00, badge:{text:'HOT DEAL',type:'hot'}, features:['Valid for 7 days','Fast delivery (1-5 mins)','All networks supported','24/7 customer support'] },
        { _id:'2', name:'5GB Monthly', size:'5GB', price:15.00, originalPrice:25.00, badge:{text:'POPULAR',type:'popular'}, features:['Valid for 30 days','Fast delivery (1-5 mins)','All networks supported','Priority support'] },
        { _id:'3', name:'10GB Monthly', size:'10GB', price:28.00, originalPrice:45.00, badge:{text:'BEST VALUE',type:'best-value'}, features:['Valid for 30 days','Fast delivery (1-5 mins)','All networks supported','VIP support & rewards'] }
    ]);
}
